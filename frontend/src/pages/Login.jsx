  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      if (result.otpRequired) {
        ...
        navigate(`/verify-otp?email=${encodeURIComponent(result.email)}&purpose=LOGIN`);
      } else {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <div className="d-flex justify-content-between align-items-center mb-1">
                ...
                <Link to="/forgot-password" style={{ color: '#6366f1', fontSize: '0.8rem', fontWeight: '500', textDecoration: 'none' }}>Forgot Password?</Link>
              </div>
              <input
                type="password"
                className="form-control"
